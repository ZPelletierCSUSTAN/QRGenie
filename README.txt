QQRGenie is an app made by Zachory Pelletier. Created using Gemini 3 Pro Preview AI model using Google AI Studio.
...
File Structure & Functionality:
    ...
    templates/page1.html: Batch QR Code Generator.
        ...
        Background color forced to white for batch items to ensure scanability.
